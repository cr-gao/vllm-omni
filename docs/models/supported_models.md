...
| `SanaImageToVideoPipeline` | SANA-Video-2B I2V (native 480p/720p; Diffusers adapter validated only at 480p) | `Efficient-Large-Model/SANA-Video_2B_480p_diffusers`, `Efficient-Large-Model/SANA-Video_2B_720p_diffusers` | ✅︎ | | | |
