...
_DIFFUSION_MODELS = {
    ...
    "SanaVideo2Pipeline": ("sana_video2", "pipeline_sana_video2", "SanaVideo2Pipeline"),
    "SanaVideoPipeline": (
        "sana_video",
        "pipeline_sana_video",
        "SanaVideoPipeline",
...
_DIFFUSION_POST_PROCESS_FUNCS = {
    ...
    "SanaVideo2Pipeline": "get_sana_video2_post_process_func",
...
_DIFFUSION_PRE_PROCESS_FUNCS = {
    ...
    "SanaVideo2Pipeline": "get_sana_video2_pre_process_func",
